    ...
    for _ in range(200): # trains for a total of 20M steps
        ...
        for iter in range(1000):
            ...
            if additional_steps < 1000:
                ...
                additional_steps = f"{additional_steps/1000}m".replace(".0","") # rid of trailing 0
            additional_steps.replace(".","_") # rid of period in name
        ...
        if not os.path.isfile(INITIAL_MODEL_PATH):
            ...
            STEPS = 300_000 # initial should be trained on 300,000 time steps
