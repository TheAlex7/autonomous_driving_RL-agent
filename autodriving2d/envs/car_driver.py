# MINIMALLY changed original source code of Car Racing to allow our 
# RL agent to drive on the original track
# CHANGES: 
#   - Obs space
#       - Goal Coordinates
...
class CarDrive(gym.Env, EzPickle):
    """
    ## Description
    ...
    * `continuous=True` specifies if the agent has continuous (true) or discrete (false) actions.
    ...
    def reset(
        ...
        *,
        ...
        self.end_pos: tuple[int,int] | None = (-PLAYFIELD, self.car.hull.position[1])
...
if __name__ == "__main__":
    ...
    env = CarDrive(render_mode="human")
